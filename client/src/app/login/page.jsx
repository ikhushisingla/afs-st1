...
const Page = () => {
  ...
  return (
        <div className='max-w-screen-2xl w-full h-screen flex items-center'>
            <FormContainer>           
              <p className='text-center py-3 font-semibold'>Welcome!</p>
              <form className='flex flex-col' onSubmit={handleSubmit}>
                  ...
                  <button type='submit' disabled={loading} className='bg-[#656ED3] rounded-full px-2 mt-12 py-1 text-white sm:px-1'>{loading?<span className='loader'></span>:'Login'}</button>
              </form>
